mlflow doctor #Check the environment and configuration

mlflow doctor --mask-envs #Masks environment variables
...
mlflow runs list --experiment-id 6 --view "all" #Lists all the run associated with an experiment
